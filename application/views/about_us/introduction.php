...
<div class="row about">
    <div class="col-sm-12">
        <h1>معرفی وزارت شهرسازی و اراضی</h1>
        <p>اصلاح ساختار های قانونی و تشکیلاتی ادارات دولتی به منظور رشد شاخص های مرتبط و دست یابی به یک وضعیت مطلوب از جمله اقدامات اساسی غرض اصلاح نظام اداری تلقی می گردد که زمینه موفقیت را در جهت ارائه خدمات بهتر برای اتباع یک مملکت فراهم می نماید. با توجه به چنین سیاست گذاری ها وزارت  شهرسازی و مسکن و اداره اراضی افغانستان در چارچوب یک واحد اداری با ماموریت یکسان تحت نام وزارت شهر سازی و اراضی به اساس فرمان شماره  ۱۰۷ مورخ ۱۰/۹ /۱۳۹۷مقام عالی ریاست ج.ا.ا منظور گردیده است.</p>
        <hr>    
        <h1>تاریخچه وزارت شهر سازی و مسکن </h1>
        <p>وزارت شهر سازی و مسکن در سال ۱۳۴۰ در چوکات وزارت فواید عامه وقت تحت نام مدیریت عمومی شهرسازی اساس گذاشته شد و سپس در سال 1344 به ریاست عمومی شهرسازی و خانه سازی ارتقأ یافت. متعاقباٌ در چوکات وزارت فواید عامه بحیث یک تصدی انتفاعی تحت نام  شتپا (د ښاري او تعمیراتي پروژو جوړولو انستیتیوت) به فعالیت ادامه داد و بعد در سال 1363 به انستیتیوت مرکزی پما (پروژه سازی) تغییر نام یافت. متعاقباَ در سال 1371 به وزارت شهرسازی و مسکن ارتقأ نموده، در سال 1385 به وزارت انکشاف شهری، در سال 1390 به وزارت امور شهر سازی و در سال1396 به وزارت شهرسازی و مسکن تغییر نام یافت. </p>
        <hr>
        <h1>تاریخچه اداره اراضی افغانستان</h1>
        <p>دولت افغانستان از آغاز سال ۱۲۸۰ خورشیدی روی تنظیم و اداره زمین، منحیث وسیله جمع آوری مالیات تمرکز داشته و در گذشته، وزارت های امور داخله و مالیه، مسولیت انجام این امور را عهده دار بودند که بعد در سال ۱۳۵۷ خورشیدی به وزارت زراعت منتقل شد. در سال ۱۳۴۳ خورشیدی ریاست های املاک و کدستر در چوکات وزارت مالیه ایجاد و منتج به تهیه اولین دفتر دقیق زمین گردید. ریاست کدستر در سال ۱۳۵۳ خورشیدی بنابر تصمیم سیاسی از وزارت مالیه مجزا و به اداره عمومی جیودیزی و کارتوگرافی مدغم گردید، که این امر باعث شد، تا اداره املاک دسترسی مستقیم به نقشه های کدستری نداشته باشد.
