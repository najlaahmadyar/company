...
<div class="row about">
    ...
    <h2 class="col-sm-12 contact_title"><?php echo lang('contact'); ?></h2>
    ...
    <div class="col-sm-12 contact-text c_f_text"><?php echo lang('c_t_text'); ?></div>

    <div class="col-sm-12 contact-text c_f_text"><?php echo lang('c_v_text'); ?></div>
