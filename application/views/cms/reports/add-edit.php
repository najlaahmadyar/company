                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="title_dari" id="title_dari" type="text" value="<?php echo $report->rep_title_dari; ?>" class="form-control"/>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label class="control-label">Title Pashto</label>
                            <input name="title_pashto" id="title_pashto" type="text" value="<?php echo $report->rep_title_pashto; ?>" class="form-control"/>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label class="control-label">Title English</label>
                            <input name="title_eng" id="title_eng" type="text" value="<?php echo $report->rep_title_eng; ?>" class="form-control"/>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="date" id="date" type="text" readonly value="<?php echo $report->rep_date; ?>" class="form-control"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="desc_dari" id="desc_dari" class="form-control summernote"><?php echo $report->rep_desc_dari; ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="desc_pashto" id="desc_pashto" class="form-control summernote"><?php echo $report->rep_desc_pashto; ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="desc_eng" id="desc_eng" class="form-control summernote"><?php echo $report->rep_desc_eng; ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
